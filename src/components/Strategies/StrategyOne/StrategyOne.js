...
import strategyImg from '../../../assets/images/home/strategy-shape.png';
import strategyImg1 from '../../../assets/images/home/strategy/1.jpg';
import strategyImg2 from '../../../assets/images/home/strategy/2.jpg';
import strategyImg3 from '../../../assets/images/home/strategy/3.jpg';
import strategyImg4 from '../../../assets/images/home/strategy/4.jpg';
...
const StrategyOne = () => {
    return (
        <section className="Strategy-section">
            {/* <!-- Shape --> */}
            <div className="strategy-shape"><img src={strategyImg} alt="" /></div>

            <div className="container">
                <div className="row">
                    <div className="col-lg-12 text-center">
                        <div className="sub-title-2"><span>Our Strategy</span></div>
                ...
                <div className="row">
                    ...
                    {/* <!--  Strategy Item Start --> */}
                    {
                        strategies?.map(strategy => {
                            return (
                                <div key={strategy?.id} className="col-lg-3 col-md-6">
                                    ...
                                    <div className="strategy-item">
                                        ...
                                        <div className="st-details">
                                            ...
                                            <h4><Link to={strategy?.link}>{strategy.title}</Link></h4>
                                        </div>
                                    </div>
                                </div>
                            )
